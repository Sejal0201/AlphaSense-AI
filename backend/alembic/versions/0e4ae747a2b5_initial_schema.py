...
Revision ID: 0e4ae747a2b5
Revises: 
Create Date: 2026-06-29 18:22:10.320506
...
def upgrade() -> None:
    ...
    sa.Column('role', sa.Enum('ADMIN', 'USER', 'ANALYST', name='user_role'), nullable=False),
